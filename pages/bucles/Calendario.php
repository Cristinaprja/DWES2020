...
class Calendario {
    ...
    public function calcularCalendario(){
        ...
        array_push($this->diasFestivos[$mesDePascua-1],$juevesDePascua);
        array_push($this->diasFestivos[$mesDePascua-1],($juevesDePascua+1)); 
    ...
    public function imprimirCalendario(){
        ...
        for($i=1; $i<$this->diasDelMes; $i++){
            if(($i+$this->huecosBlancos)%7==0){
                ...
                echo "<tr>";
            }elseif(in_array($i, $this->diasFestivos[$this->mes])){
                echo "<td style=\"background-color: red\">$i</td>";
